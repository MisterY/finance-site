...
////////////////////////////////////////////////////////////////////
// Style for the vertical menu. A few differences.
// ItemSeparatorSize = 0
...
c_menus['MenuH']=[ // the UL element with id="Menu1"
[
// MAIN-MENU FEATURES
...
c_menus['MenuV']=[ // the UL element with id="Menu1"
[
// MAIN-MENU FEATURES
...
0,		// X SubMenuOffset (pixels)
0,		// Y SubMenuOffset
'auto',		// Width (values in CSS valid units - px,em,ex) (matters for main menu with 'vertical' ItemsArrangement only), was 10em
'MMV',		// CSS Class (one of the defined in section 2)
false		// Open sub-menus onclick (default is onmouseover)
],[
// SUB-MENUS FEATURES
5,		// X SubMenuOffset (pixels)
